...
int my_string_get_size2(MY_STRING hMy_string);
...
GENERIC_VECTOR generic_vector_init_default(Status (*item_assign)(Item_ptr, Item), void (*item_destroy)(Item_ptr));
...
//Postcondition: returns a copy of the handle of the index'th element
//of the array if it exists and NULL otherwise.
